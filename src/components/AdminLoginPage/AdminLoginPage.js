...
export default function AdminLoginPage() {
  ...
  const loginAdmin = async (e) => {
    e.preventDefault();
    fetch("http://localhost:9000/api/loginAdmin", {
      method: "POST",
      headers: {
      ...
      <div className="d-flex flex-row justify-content-around">
        ...
        <div className="m-0 p-0">
          <img 
            ...
            className="computer_admin_image image-fluid"
            alt="sample"
          />
        </div>
        ...
        <form className="mt-5 me-5" method="post" onSubmit={loginAdmin}>
          <img src="https://www.linkpicture.com/q/admin.png" className="admin_image ms-4" alt="admin" srcSet=""/>
